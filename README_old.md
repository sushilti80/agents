...
An intelligent Azure architecture assistant powered by Agentic Framework and Azure OpenAI with Microsoft Entra ID (Azure AD) SSO authentication, persistent session management, and multi-mode architecture expertise.
